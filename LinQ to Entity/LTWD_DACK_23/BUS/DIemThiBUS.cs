...
namespace BUS
{
    public class DIemThiBUS
    {
        ...
        public List<spGetDiemTheoMSSV_Result> getDiemTheoMSSV(string maSV)
        {
            return db.spGetDiemTheoMSSV(maSV).ToList();
        }

        public List<spGetDiemTheoMSSV_MaHP_Result> getDiemTheoMSSV_MaHP(string maSV, string maHP)
        {
